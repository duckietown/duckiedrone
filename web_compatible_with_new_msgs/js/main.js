...
function init() {
    ...
    batterysub.subscribe(function(message) {
      ...
      var mynumber = myround(message.voltage, 2);
      document.getElementById('voltage').innerHTML=mynumber
      if (message.voltage <= 11.3) {
        document.getElementById('voltage').innerHTML=mynumber + " EMPTY!";
        $('#voltage').addClass('alert-danger').removeClass('alert-success');
      } else {
        document.getElementById('voltage').innerHTML=mynumber;
        $('#voltage').addClass('alert-success').removeClass('alert-danger');
      }
    ...
    function ukfCallback(message) {
      ...
      // x-y pair
      var zEstimate = message.pose.pose.position.z;
      var xyPair = {
          x: tVal,
          y: zEstimate
      }
      ...
      var heightVariance = message.pose.covariance[14];
